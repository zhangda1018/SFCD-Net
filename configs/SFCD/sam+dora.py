...
custom_imports = dict(imports=['mmseg.sfcd'], allow_failed_imports=False)
...
default_hooks = dict(
    ...
    visualization=dict(type='CDVisualizationHook', interval=1, img_shape=(1024, 1024, 3),draw=False)
)
vis_backends = [dict(type='CDLocalVisBackend'),
                
                dict(type='WandbVisBackend', init_kwargs=dict(project='samcd', group='levircd', name='sfcd_sam_large_levircd_fp16'))
                ]
